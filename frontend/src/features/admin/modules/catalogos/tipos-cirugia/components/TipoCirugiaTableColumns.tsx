...
interface BuildTipoCirugiaTableColumnsOptions {
  canReadTipoCirugia: boolean;
  canUpdateTipoCirugia: boolean;
  canDeleteTipoCirugia: boolean;
  isStatusPending: boolean;
  onOpenDetails: (item: TipoCirugiaListItem) => void;
  onToggleStatus: (item: TipoCirugiaListItem) => void;
  onRequestDelete: (item: TipoCirugiaListItem) => void;
}

export const buildTipoCirugiaTableColumns = ({
  canReadTipoCirugia,
  canUpdateTipoCirugia,
  canDeleteTipoCirugia,
  isStatusPending,
  onOpenDetails,
  onToggleStatus,
  onRequestDelete,
}: BuildTipoCirugiaTableColumnsOptions): DataTableColumn<TipoCirugiaListItem>[] => {
  const baseColumns: DataTableColumn<TipoCirugiaListItem>[] = [
    {
      key: "name",
      header: "Nombre",
      accessorKey: "name",
  ...
  const actionColumn: DataTableColumn<TipoCirugiaListItem> = {
    key: "actions",
...
export const buildTipoCirugiaVisibilityOptions = (
  showActions: boolean,
