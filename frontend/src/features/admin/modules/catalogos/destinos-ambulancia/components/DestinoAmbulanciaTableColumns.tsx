...
interface BuildDestinoAmbulanciaTableColumnsOptions {
  canReadDestinoAmbulancia: boolean;
  canUpdateDestinoAmbulancia: boolean;
  canDeleteDestinoAmbulancia: boolean;
  isStatusPending: boolean;
  onOpenDetails: (item: DestinoAmbulanciaListItem) => void;
  onToggleStatus: (item: DestinoAmbulanciaListItem) => void;
  onRequestDelete: (item: DestinoAmbulanciaListItem) => void;
}

export const buildDestinoAmbulanciaTableColumns = ({
  canReadDestinoAmbulancia,
  canUpdateDestinoAmbulancia,
  canDeleteDestinoAmbulancia,
  isStatusPending,
  onOpenDetails,
  onToggleStatus,
  onRequestDelete,
}: BuildDestinoAmbulanciaTableColumnsOptions): DataTableColumn<DestinoAmbulanciaListItem>[] => {
  const baseColumns: DataTableColumn<DestinoAmbulanciaListItem>[] = [
    {
      key: "name",
      header: "Nombre",
      accessorKey: "name",
  ...
  const actionColumn: DataTableColumn<DestinoAmbulanciaListItem> = {
    key: "actions",
...
export const buildDestinoAmbulanciaVisibilityOptions = (
  showActions: boolean,
