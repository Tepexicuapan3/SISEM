      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            permissions: ["admin:catalogos:cie9_mc:read"],
          },
          {
            title: "Tipos de Cirugía",
            url: "/admin/catalogos/tipos-cirugia",
            permissions: ["admin:catalogos:tipos_cirugia:read"],
          },
          {
            title: "Clasificaciones de Cirugía",
            url: "/admin/catalogos/clasificaciones-cirugia",
            permissions: ["admin:catalogos:clasificaciones_cirugia:read"],
          },
          {
            title: "Motivos de Cancelación de Cirugía",
            url: "/admin/catalogos/motivos-cancelacion-cirugia",
            permissions: ["admin:catalogos:motivos_cancelacion_cirugia:read"],
          },
          {
            title: "Motivos de Traslado",
            url: "/admin/catalogos/motivos-traslado",
            permissions: ["admin:catalogos:motivos_traslado:read"],
          },
          {
            title: "Tipos de Traslado",
            url: "/admin/catalogos/tipos-traslado",
            permissions: ["admin:catalogos:tipos_traslado:read"],
          },
          {
            title: "Tipos de Servicio de Ambulancia",
            url: "/admin/catalogos/tipos-servicio-ambulancia",
            permissions: ["admin:catalogos:tipos_servicio_ambulancia:read"],
          },
          {
            title: "Destinos de Ambulancia",
            url: "/admin/catalogos/destinos-ambulancia",
            permissions: ["admin:catalogos:destinos_ambulancia:read"],
          },
        ],
      },
      {
